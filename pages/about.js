    ...
    return (
      ...
      <span className={styles.about_me_info}>
        <p className={styles.about_me_text}>
          Hi, I am Tom, a developer who enjoys challenges
          and problem solving. I have recently completed a coding bootcamp with
          ...
          some amazing people along the way. I am excited to continue my learning
          by both cementing my knowledge of the technologies I have already used
          ...
          to World of Warcraft. You will mainly catch me playing Football Manager
